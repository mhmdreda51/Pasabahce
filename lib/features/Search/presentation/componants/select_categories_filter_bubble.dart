...
class SelectCategoriesFilterBubble extends StatelessWidget {
  const SelectCategoriesFilterBubble({Key? key, required this.cubit})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Wrap(
      children: selectCategoriesFilterButtonList
          .map(
            (item) => Padding(
